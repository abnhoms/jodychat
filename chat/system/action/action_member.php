...
function clearAllPriv($hunter){
	global $mysqli;

	$mysqli->query("DELETE FROM boom_private WHERE hunter = '$hunter' OR target = '$hunter'");
	$mysqli->query("DELETE FROM boom_conversation WHERE hunter = '$hunter' OR target = '$hunter'");
